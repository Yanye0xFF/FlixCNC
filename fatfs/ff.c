 ...
 * @param chk_wp !=0: Check media write protection for wrinting fuctions
 * @return FR_OK(0): successful, !=0: any error occured
 * */
static
FRESULT auto_mount(const char **path, FATFS **rfs, BYTE chk_wp) {
    BYTE drv, fmt, *tbl;
    DSTATUS stat;
...
/**
 * Mount/Unmount a Locical Drive
 * @param drv Logical drive number to be mounted/unmounted
